...
class GetCategoriesAspectResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('categoryAspects', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $categoryTreeVersion The version of the category tree that is returned in the <b>categoryTreeId</b> field.
     *
     * @return self
     */
    ...
    {
        if (is_null($categoryAspects)) {
            throw new \InvalidArgumentException('non-nullable categoryAspects cannot be null');
        }
