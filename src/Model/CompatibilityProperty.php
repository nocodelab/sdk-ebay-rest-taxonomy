...
class CompatibilityProperty implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('localizedName', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets localizedName
     *
     * @param string|null $localizedName This is the localized name of the compatible vehicle property. The language that is used will depend on the user making the call, or based on the language specified if the <strong>Content-Language</strong> HTTP header is used.<br/><br/>In some instances, the string value in this field may be the same as the string in the corresponding <strong>name</strong> field.
     *
     * @return self
     */
    public function setLocalizedName($localizedName)
    {
        if (is_null($localizedName)) {
            throw new \InvalidArgumentException('non-nullable localizedName cannot be null');
        }
