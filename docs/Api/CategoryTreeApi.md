...
```php
getCategorySubtree($categoryId, $categoryTreeId): \macropage\SDKs\ebay\rest\taxonomy\Model\CategorySubtree
```
...
try {
    $result = $apiInstance->getCategorySubtree($categoryId, $categoryTreeId);
    print_r($result);
} catch (Exception $e) {
...
```php
getCategoryTree($categoryTreeId): \macropage\SDKs\ebay\rest\taxonomy\Model\CategoryTree
```
...
try {
    $result = $apiInstance->getCategoryTree($categoryTreeId);
    print_r($result);
} catch (Exception $e) {
...
```php
getDefaultCategoryTreeId($marketplaceId, $acceptLanguage): \macropage\SDKs\ebay\rest\taxonomy\Model\BaseCategoryTree
```
...
$marketplaceId = 'marketplaceId_example'; // string | The ID of the eBay marketplace for which the category tree ID is being requested. For a list of supported marketplace IDs, see <a href=\"/api-docs/commerce/taxonomy/static/supportedmarketplaces.html\">Marketplaces with Default Category Trees</a>.
...
try {
    $result = $apiInstance->getDefaultCategoryTreeId($marketplaceId, $acceptLanguage);
    print_r($result);
} catch (Exception $e) {
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **marketplaceId** | **string**| The ID of the eBay marketplace for which the category tree ID is being requested. For a list of supported marketplace IDs, see &lt;a href&#x3D;\&quot;/api-docs/commerce/taxonomy/static/supportedmarketplaces.html\&quot;&gt;Marketplaces with Default Category Trees&lt;/a&gt;. | |
| **acceptLanguage** | **string**| A header used to indicate the natural language the seller prefers for the response.&lt;br /&gt;&lt;br /&gt;This specifies the language that the seller wants to use when the field values provided in the request body are displayed to consumers.&lt;br /&gt;&lt;br /&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt; &lt;strong&gt;Note:&lt;/strong&gt; For details, see &lt;i&gt;Accept-Language&lt;/i&gt; in &lt;a href&#x3D;\&quot;/api-docs/static/rest-request-components.html#headers\&quot;&gt;HTTP request headers&lt;/a&gt;.&lt;/span&gt;&lt;br /&gt;&lt;br /&gt;&lt;b&gt;Valid Values:&lt;/b&gt; &lt;ul&gt;&lt;li&gt;For EBAY_CA in French:&lt;br /&gt;&lt;code&gt;Accept-Language: fr-CA&lt;/code&gt;&lt;/li&gt;&lt;li&gt;For EBAY_BE in French:&lt;br /&gt;&lt;code&gt;Accept-Language: fr-BE&lt;/code&gt;&lt;/li&gt;&lt;/ul&gt; | [optional] |
